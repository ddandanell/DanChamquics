      ...
      <div className="max-w-3xl w-full">
        ...
        <AnimatePresence mode="wait">
          <motion.div
            ...
            className="bg-white rounded-2xl shadow-2xl p-8 md:p-12 mt-8"
          >
            {/* Question Header */}
            <div className="text-center mb-8">
              ...
              <motion.h2
                ...
                className="text-2xl md:text-3xl font-bold text-dancham-navy mb-2"
              >
                ...
                >
                  <div className="flex items-start gap-4">
                    ...
                    <div className="flex-1">
                      ...
                      {option.subtitleDA && (
                        <p className={`text-sm ${selectedAnswer === option.id ? 'text-white/90' : 'text-gray-600'}`}>
  ...
  return (
    <div className="bg-white rounded-full p-4 shadow-lg">
      <div className="flex items-center justify-between mb-2">
        <span className="text-sm font-semibold text-dancham-navy">
        ...
        <span className="text-sm font-semibold text-dancham-red">{Math.round(progress)}%</span>
      </div>
